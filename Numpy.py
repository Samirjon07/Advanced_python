...
print(x[1]) #accesing elements of array called x by using array
print(y[1]) #accesing elements of array called y by using array

# zero dimensional array -- which has 0, 0 addres in matrix
zero=np.array(10)
print(zero)
